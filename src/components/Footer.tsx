      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              AI-powered voice compliance monitoring for modern businesses.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-blue-600 hover:text-white transition-all duration-300">
          ...
          <div>
            <h3 className="text-gray-900 font-semibold mb-5 text-sm uppercase tracking-wider">Product</h3>
          ...
          <div>
            <h3 className="text-gray-900 font-semibold mb-5 text-sm uppercase tracking-wider">Company</h3>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#compliance" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Compliance
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            &copy; {new Date().getFullYear()} VoxGuard AI. All rights reserved.
          </p>
          <div className="flex items-center gap-2 mt-4 md:mt-0">
            <span className="text-xs text-gray-500">Made with</span>
            <span className="text-xs text-gray-600 font-medium">ElevenLabs</span>
          </div>
        </div>
      </div>
    </footer>
